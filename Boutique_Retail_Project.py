...
dbutils.fs.mount(
  source = "wasbs://project1@mayurisapkalstorage.blob.core.windows.net",
  mount_point = "/mnt/retail_project",
  extra_configs = {"fs.azure.account.key.mayurisapkalstorage.blob.core.windows.net":"secret access key"})
...
df_customers = spark.read.parquet('/mnt/retail_project/bronze/customer/MayuriSapkal-code/Clothing-Boutique-Retail-Data-Management-Analytics-Platform-/refs/heads/main/')
